# -*- coding: utf-8 -*-
#
# NDNS: DNS service for Named Data Networking documentation build configuration file, created by
...
project = u'NDNS: DNS service for Named Data Networking'
copyright = u'2013, Alexander Afanasyev'
...
htmlhelp_basename = 'NDNSDNSserviceforNamedDataNetworkingdoc'
